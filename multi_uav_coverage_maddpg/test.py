...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default=None, help="Path to the saved model directory (default: saved_models/maddpg_episode_final)")
